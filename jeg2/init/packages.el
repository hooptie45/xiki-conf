...
(add-to-list 'load-path (expand-file-name "jeg2/vendor/helm" user-emacs-directory))
(jeg2/load-init-file "jeg2/vendor/helm/helm-config")
(jeg2/load-init-file "jeg2/vendor/helm/helm-ring")
(jeg2/load-init-file "jeg2/vendor/helm/helm-tags")
