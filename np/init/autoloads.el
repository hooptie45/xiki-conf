...
(setq np-autoload-file (concat user-emacs-directory "loaddefs.el"))

(defun np/autoload-directories (directories)
  "Regenerate the autoload definitions file if necessary and load it."
  (let ((autoload-file np-autoload-file))
