;;;###autoload
(defun np/comment-or-uncomment-region-or-line ()
...
;;;###autoload
(defun np/insert-header-comment ()
  ...
  (let ((header))
    ...
    (let* ((ender (np/string-trim (or comment-end "")))
           (starter (np/string-trim (or comment-start "#")))
           ...
           (indent-size (length
                         (np/regex-replace
                          ...
                          (concat "\\(" (regexp-quote
                                  ...
                                  "\\)+$") "")))
           (outdent-size (length (np/regex-replace
                                  ender
                                  (concat "^\\("
                                          (regexp-quote
                                           (char-to-string starter-tail))
